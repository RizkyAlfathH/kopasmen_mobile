...
class _HomePageState extends State<HomePage> {
  int _currentIndex = 2; // ✅ default di Home
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ✅ Bottom Navigation dengan currentIndex
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          setState(() {
            ...
            // Jika yang diklik adalah Pinjaman, navigasi ke halaman Pinjaman
            if (index == 1) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => PinjamanPage(user: widget.user),
                ),
              );
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Text("NIP : ", style: TextStyle(color: Colors.black54)),
          ...
          ListView(
            ...
            children: [
              ...
              _buildHistoryItem(Icons.savings, "Setoran Simpanan Wajib", "11 Mei 2025", "+ Rp. 200.000", true),
